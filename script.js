...
const addParent = document.getElementById('add');
...
add.addEventListener('input', () => {
    const addValue = add.value.trim(); // Trim whitespace from the input value
    if (addValue !== "") {
...
function addFullStar() {
    ...
    container.addEventListener('click', (e) => {
        ...
        const parentStar = clickedStar.closest('.to-do');
